...
urlpatterns = [
    ...
    path('products/order_by_comments/', views.ProductListOrderByCommentListView.as_view(), name='product_order_by_comments'),
    ...
    path('categories/<str:slug>/order_by_comment/', views.CategoryOrderByCommentView.as_view(), name='category_order_by_comment'),
